...
@section('content')
    <div class="col-md-9 col-sm-11 px-5 pl-md-2 pt-2 main mx-auto">
        <div class="card">
            <div class="card-header">Support Workers
                <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#newSupportWorker">
                    Add
                </button></div>

                <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-center">
                    @if(count($supportWorkers) > 0 )
                        @foreach ($supportWorkers as $supportWorker)

                                <div class="card m-4" style=" width:270px">
                                    <img class="card-img-top " style="width:200px;" src="/storage/profile_images/{{$supportWorker->profile_image}}" alt="Profile image">
                                    <div class="card-body">
                                        <h4 class="card-title">{{$supportWorker->name}}</h4>
                                        <p class="card-text"> DBS Number: {{$supportWorker->dbs_num}}</p>
                                        <a href="/supportWorkers/{{$supportWorker->id}}" class="btn btn-primary">See Profile</a>
                                    </div>
                                </div>
                            <br>
                        @endforeach
    ...
    <!-- The Modal -->
    <div class="modal fade" id="newSupportWorker">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('supportWorkers.store') }}" aria-label="{{ __('Add User') }}">
                        @csrf
